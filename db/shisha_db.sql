...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2022 at 05:30 PM
...
(0, NULL, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Montes nascetur ridiculus mus mauris vitae ultricies leo integer. Fermentum odio eu feugiat pretium nibh ipsum consequat. Non diam phasellus vestibulum lorem. Rutrum quisque non tellus orci ac auctor. Aliquam sem et tortor consequat id porta nibh venenatis. Est sit amet facilisis magna etiam tempor orci eu lobortis. Pulvinar mattis nunc sed blandit libero volutpat sed. Ultrices neque ornare aenean euismod elementum nisi quis eleifend. Feugiat nibh sed pulvinar proin. Vitae tempus quam pellentesque nec. Nulla malesuada pellentesque elit eget gravida cum sociis natoque penatibus. Proin sed libero enim sed faucibus turpis. Urna nunc id cursus metus aliquam eleifend. Temp');
...
(1, 0, 0, 'admin@email.com', '$2y$10$ZBe3udFijMgmuC5KTvG43e9CGPVql7Qm0fmgCklUP/QMliZ0dNSaS');
...
(0, 'CONTACT@EMAIL.COM', '514-420-696', '821 AV. SAINTE-CROIX, SAINT-LAURENT, QC H4L39X', 'John Doe');
...
(18, 'DOPE 360', 'OVO', 'A perfect tribute to a true smoker – blow clouds like Big Poppa with a hookah set made for a superstar. The sporty modern design gives the R.E.D. a clean-cut look that never gets old.\r\n\r\nEnjoy a shisha pipe that arrives readily assembled with straightforward directions for use, allowing you to relax', 40, '259.95', '6269f937ca11f.jpg', 'Modern', 'Red'),
